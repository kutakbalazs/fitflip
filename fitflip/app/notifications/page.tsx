...
export default function NotificationsPage() {
  ...
  const t = lang === "hu"
    ? {
        ...
        emptySub: "Aktiválj árfigyelőt egy scan-eredménynél, és szólunk, amint új hirdetés bukkan fel a célárad alatt.",
    ...
    : {
        ...
        emptySub: "Activate a price watcher on a scan result and we'll ping you as soon as a new listing appears under your target.",
