...
export default function BackToTop({ threshold = 600, lang = "hu" }: Props) {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 w-11 h-11 rounded-full bg-ink-900 dark:bg-ink-700 text-white shadow-lg hover:bg-ink-700 transition fade-in flex items-center justify-center"
    >
